...
export type FormsShortViewQuery = { __typename?: 'Query', forms: Array<{ __typename?: 'Form', id: string, description?: string | null, title: string }> };
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    FormsShortView: build.query<FormsShortViewQuery, FormsShortViewQueryVariables | void>({
...
export const { useCreateFormMutation, useFormsShortViewQuery, useLazyFormsShortViewQuery } = injectedRtkApi;
